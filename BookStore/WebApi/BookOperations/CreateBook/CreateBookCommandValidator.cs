...
namespace WebApi.BookOperations.CreateBook
{
    public class CreateBookCommandValidator : AbstractValidator<CreateBookCommand>{
        ...
        public CreateBookCommandValidator(){
            ...
            RuleFor(command => command.Model.PublishDate.Date).NotEmpty().LessThan(DateTime.Now.Date); //publish date in yıl bilgisi her zaman olduğumuz günden küçük olacağını garanti eder.
